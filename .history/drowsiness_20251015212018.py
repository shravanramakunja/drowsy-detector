...
class DrowsinessDetector:
    def __init__(self):
        ...
        self.EYE_CLOSED_SECONDS = 5  # Seconds before alarm triggers
        self.ASSUMED_FPS = 30  # Assumed frames per second
        self.EYE_CLOSED_FRAMES = self.EYE_CLOSED_SECONDS * self.ASSUMED_FPS  # Frames for 5 seconds
    ...
    def play_alarm(self):
        ...
        try:
            ...
            frequency = 150  # Hz (lower frequency, more attention-grabbing)
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                if len(eyes) >= 2:
                    ...
                    # Trigger alarm if eyes closed for more than 8 seconds
                    ...
                    # Display time closed
                    status_text = f"Eyes Closed: {self.eyes_closed_time:.1f}s / {self.EYE_CLOSED_SECONDS}s"
...
def main():
    ...
    print("3. Alarm will trigger if eyes are closed for more than 5 seconds")
