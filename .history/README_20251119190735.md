...
- 🎯 **Accurate Predictions** - City, Highway, and Combined fuel efficiency (km/l)
- 📝 **Feature Engineering** - 6 key features: cylinders, displacement, transmission, class, drive, fuel type
- 🔄 **Automatic Training** - Models train on server startup using scikit-learn
...
1. **Start the Flask server:**
   ...
   ```text
   [INFO] Loading face and eye detectors...
   
   ============================================================
   Fuel Efficiency Predictor - Machine Learning Module
   ============================================================
   [INFO] Training Random Forest models...
   [INFO] Loading dataset from fuel.csv...
   [INFO] Loaded 38113 records from dataset
   [INFO] Preprocessed 38113 valid records
   [INFO] Training City MPG model...
   [INFO] Training Highway MPG model...
   [INFO] Training Combined MPG model...
   [INFO] Models trained successfully on 38113 samples!
   [INFO] Feature importance (Combined): [0.011, 0.471, 0.016, 0.047, 0.045, 0.410]
   ============================================================
...
- **Load Sample Vehicle:** Choose from 12 pre-loaded realistic profiles (Toyota Camry, Ford F-150, Tesla Model 3, etc.)
- **Enter Custom Data:** Specify engine size, weight, horsepower, transmission, vehicle type
- **Get ML Predictions:** Random Forest model returns City/Highway/Combined efficiency in km/l
- **View Model Info:** See dataset size (38,113 vehicles) and model type in results

**How ML Prediction Works:**

1. Backend loads `dataset/fuel.csv` with 38,113 vehicle records
2. Preprocesses data: handles missing values, converts MPG → km/l
3. Trains 3 Random Forest models (150 estimators, max_depth=15)
4. Feature engineering: encodes transmission, class, drive, fuel type
5. Predicts using 6 features: cylinders, displacement, transmission, class, drive, fuel
6. Returns accurate City/Highway/Combined fuel efficiency
...
├── app.py                 # Flask backend server + ML models
├── requirements.txt       # Python dependencies (includes scikit-learn, pandas)
├── README.md             # Project documentation
├── QUICKSTART.md         # Quick setup guide
├── dataset/              # Machine Learning datasets
│   └── fuel.csv          # 38,113 vehicle records for ML training
├── web/                  # Web application files
│   ├── index.html        # Main HTML page
│   ├── styles.css        # CSS styling
│   ├── script.js         # Frontend JavaScript + ML API integration
...
| **scikit-learn 1.3** | Machine learning - Random Forest algorithm |
...
- 🎯 Improve detection accuracy (dlib, MediaPipe)
- 🌐 Add multi-language support
- 📊 Add statistics dashboard for driver behavior
- 🔊 Additional alert types (vibration, notifications)
- 📱 Mobile app version
- 🧪 Add unit tests for ML models and API
- 📚 Improve documentation
- 🎨 UI/UX enhancements
- 🤖 Add more ML models (neural networks, XGBoost)
- 📈 Display ML model accuracy metrics in UI
